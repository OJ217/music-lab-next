...
const InDevelopmentBanner = () => {
	return (
		<div className='mx-auto grid max-w-sm place-items-center space-y-2 rounded-lg border-violet-600 bg-transparent bg-gradient-to-tr from-violet-600/10 to-violet-600/20 p-4 md:space-y-4 md:p-6'>
