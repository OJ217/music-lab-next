		...
		<EarTrainingLayout centered={false}>
			<div className='mx-auto w-full max-w-md space-y-8'>
				<div className='space-y-4'>
					...
					<div className='flex snap-x snap-mandatory gap-4 overflow-x-scroll scroll-smooth shadow-inner scrollbar-none'>
						<Link
							href={'/ear-training/practice/interval'}
							className='from flex w-full flex-none snap-center items-center justify-between gap-2 rounded-xl bg-gradient-to-tr from-violet-600/[0.15] to-violet-600/25 px-6 py-4 transition-all duration-500 ease-in-out hover:opacity-80'
						>
							<div className='space-y-2'>
								<h3 className='text-xl font-semibold leading-none text-violet-400'>Interval</h3>
								<p className='text-sm leading-4 text-violet-100'>Distance between two notes</p>
								<Badge
									color='violet'
									variant='light'
									size='sm'
						...
						<Link
							...
							className='from flex w-full flex-none snap-center items-center justify-between gap-2 rounded-xl bg-gradient-to-tr from-sky-600/[0.15] to-sky-600/25 px-6 py-4 transition-all duration-500 ease-in-out hover:opacity-80'
						>
							<div className='space-y-2'>
								<h3 className='text-xl font-semibold leading-none text-sky-300'>Chord</h3>
								<p className='text-sm leading-4 text-sky-100'>Combination of three or more notes</p>
								<Badge
									color='blue'
									variant='light'
									size='sm'
						...
						<Link
							...
							className='from flex w-full flex-none snap-center items-center justify-between gap-2 rounded-xl bg-gradient-to-tr from-amber-600/[0.15] to-amber-600/25 px-6 py-4 transition-all duration-500 ease-in-out hover:opacity-80'
						>
							<div className='space-y-2'>
								<h3 className='text-xl font-semibold leading-none text-amber-200'>Mode</h3>
								<p className='text-sm leading-4 text-amber-100'>Specific scale or tonal pattern</p>
								<Badge
									color='orange'
									variant='light'
									size='sm'
				...
				<div className='space-y-4'>
					...
					<div className='grid grid-cols-2 gap-4'>
						<div className='from flex flex-col justify-between gap-2 rounded-xl bg-transparent bg-gradient-to-tr from-emerald-600/20 to-emerald-600/60 px-6 py-4 shadow-md transition-all duration-500 ease-in-out hover:opacity-80'>
							<div className='space-y-2'>
						...
						<div className='from flex flex-col justify-between gap-2 rounded-xl bg-gradient-to-tr from-amber-600/20 to-amber-600/60 px-6 py-4 shadow-md transition-all duration-500 ease-in-out hover:opacity-80'>
							<div className='space-y-2'>
						...
						<div className='from flex flex-col justify-between gap-2 rounded-xl bg-gradient-to-tr from-violet-600/20 to-violet-600/60 px-6 py-4 shadow-md transition-all duration-500 ease-in-out hover:opacity-80'>
							<div className='space-y-2'>
						...
						<div className='from flex flex-col justify-between gap-2 rounded-xl bg-transparent bg-gradient-to-tr from-sky-600/20 to-sky-600/60 px-6 py-4 shadow-md transition-all duration-500 ease-in-out hover:opacity-80'>
							<div className='space-y-2'>
						...
						<div className='from flex flex-col justify-between gap-2 rounded-xl bg-transparent bg-gradient-to-tr from-yellow-600/20 to-yellow-600/60 px-6 py-4 shadow-md transition-all duration-500 ease-in-out hover:opacity-80'>
							<div className='space-y-2'>
						...
						<div className='from flex flex-col justify-between gap-2 rounded-xl bg-transparent bg-gradient-to-tr from-indigo-600/20 to-indigo-600/60 px-6 py-4 shadow-md transition-all duration-500 ease-in-out hover:opacity-80'>
							<div className='space-y-2'>
