	...
	return (
		<ProtectedRoute>
			<main className='flex min-h-screen flex-col text-white'>
				{/* Navigation */}
				<nav className='absolute -top-[20%] z-50 !h-[70px] w-full flex-none backdrop-blur' />
				<nav className='sticky top-[env(safe-area-inset-top)] z-50 w-full flex-none border-b-2 border-violet-600/10 bg-transparent bg-gradient-to-tr from-violet-600/5 to-violet-600/20 px-4 py-3 backdrop-blur md:px-6 md:py-4'>
